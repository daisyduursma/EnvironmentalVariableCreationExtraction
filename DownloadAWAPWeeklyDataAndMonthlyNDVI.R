...
for(i in 1:length(dates)){
  ...
  download.file(paste0("http://www.bom.gov.au/web03/ncc/www/awap/solar/solarave/week/grid/0.05/history/nat/",Y,M,D,y2,m2,d2,".grid.Z"),
...
for(i in 1:length(dates)){
  ...
  download.file(paste0("http://www.bom.gov.au/web03/ncc/www/awap/rainfall/totals/week/grid/0.05/history/nat/",Y,M,D,y2,m2,d2,".grid.Z"),
                paste0("/Users/daisy/Google Drive/PhD/Data/Spatial/Climate/AWAP/WeeklyPrec/",Y,M,D,y2,m2,d2,".grid.Z"),
                mode="w",method="curl")
